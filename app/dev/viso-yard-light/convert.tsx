...
// LIGHT-THEME VARIANT — local tokens inverted (dev-only, matches ./_shared.tsx)
const DARK = "#ECEDEF";
const TXT_D1 = "#13151A";
const TXT_D2 = "#5A5F6A";
const TXT_L1 = "#F4F5F7"; // fill-button text — contrasts against the now-charcoal button bg
const GRID_D = "rgba(19,21,26,0.16)";
const CROSS_D = "rgba(19,21,26,0.4)";
const SIGNAL = "#ED510C";
      ...
      <div className="hidden md:block" style={{ ...SHEET, height: 720 }}>
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "0 64px", boxSizing: "border-box" }}>
          ...
          <div style={{ marginTop: 48, display: "flex", alignItems: "center", justifyContent: "center", gap: 16 }}>
            ...
            <a href="/platform/viso-yard" className="dt-outline" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", height: 76, padding: "0 32px", background: "transparent", color: TXT_D1, border: `1px solid rgba(19,21,26,0.28)`, borderRadius: 999, fontFamily: sans, fontSize: 24, fontWeight: 500, textDecoration: "none" }}>Explore the platform</a>
          </div>
        </div>
      </div>
      ...
      <div className="md:hidden" style={{ position: "relative", height: 520 }}>
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "0 24px", boxSizing: "border-box" }}>
          ...
          <div style={{ marginTop: 32, display: "flex", flexDirection: "column", alignItems: "stretch", gap: 12, width: "100%", maxWidth: 280 }}>
            ...
            <a href="/platform/viso-yard" className="dt-outline" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", height: 52, background: "transparent", color: TXT_D1, border: `1px solid rgba(19,21,26,0.28)`, borderRadius: 999, fontFamily: sans, fontSize: 17, fontWeight: 500, textDecoration: "none" }}>Explore the platform</a>
          </div>
        </div>
      </div>
    </section>
